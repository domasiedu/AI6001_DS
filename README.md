...
## Project Folder Structure (Will be updated incrementally)
...
This structure separates user interface elements from game logic to improve maintainability and readability.
